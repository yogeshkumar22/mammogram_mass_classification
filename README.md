...
We have preprocess the data and prepare it for model building and after running multiple algorithms we have been able to achieve accuracy of 80.7% using Logistic Regression algorithm
